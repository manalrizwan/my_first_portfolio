...
if user_input == "walk":
    print("You start walking south towards the traintracks")
...
if user_input == "south":
    print("You choose to go south towards the traintracks.There is a masuqerade ball...") # finished the story writing what happens
